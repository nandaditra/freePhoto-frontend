                ...
                <div className="text-center my-3.5">
                    ...
                    <form 
                       ...
                       onSubmit={handleSearch}
                        ...
                        <button 
                           type="submit" 
                           className="p-2.5 px-3 ml-2 text-sm font-medium text-white bg-black rounded-lg border border-black hover:bg-black focus:ring-4 focus:outline-none focus:ring-black dark:bg-black dark:hover:bg-black dark:focus:ring-black">
