        ...
        <>
            ...
            <main className="">
                <div className="text-center my-3.5">
                    <h1 className="text-8xl font-bold">freePhoto</h1>
                    <p className="#">find your photo or images freely</p>
                    ...
                    <form class="flex items-center w-1/2 m-auto">   
                        ...
                        <button type="submit" class="p-2.5 ml-2 text-sm font-medium text-white bg-blue-700 rounded-lg border border-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-black dark:hover:bg-blue-700 dark:focus:ring-blue-800">
